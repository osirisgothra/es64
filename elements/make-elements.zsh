...
declare -gA elements=( "H" "Hydrogen" "He" "Helium" "Li" "Lithium" "Be" "Beryllium" "B" "Boron" "C" "Carbon" "N" "Nitrogen" "O" "Oxygen"
                      ...
                      "Pm" "Promethium" "Sm" "Samarium" "Eu" "Europium" "Gd" "Gadolinium" "Tb" "Terbium" "Dy" "Dysprosium" "Ho" "Holmium"
...
mkdir byname
for x in ${(k)elements}; do
    ln -s */elements_${(L)elements[$x]}.png byname/${x}.png
done
#cmd=$1
#dest=$2
#shift 2
#filenames=( )
#for x in $@; do
#  filenames+="elements_${(L)elements[${(U)x[1]}${x: 1}]}.png"
#done
#$cmd $filenames $dest
